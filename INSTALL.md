...
4. Start the server:
   ...
   uv run python -m scraper_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn scraper_mcp.server:app --port 10998
   ```
...
5. Open `http://localhost:10998` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/scraper-mcp/issues) |
