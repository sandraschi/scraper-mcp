                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {pid === "toolbench" && info.url && (
                      <a
                        ...
                        href={`/fix/${encodeURIComponent(repoName || "")}`}
                        className="text-[10px] px-2 py-1 rounded bg-amber-600/20 text-amber-400 hover:bg-amber-600/30 border border-amber-700/30 transition-colors"
